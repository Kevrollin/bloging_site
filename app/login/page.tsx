      ...
      <div className="hidden lg:block relative w-full max-w-md">
        ...
        <div className="absolute inset-0 flex flex-col justify-center p-10">
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-white">Discover, Learn, and Share</h2>
            <p className="text-white/90">
              Join our community of writers and readers. Explore insightful articles and find valuable resources in our
              marketplace.
            </p>
          </div>
        </div>
